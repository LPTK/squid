...
call'2 π = let
  ret = (call'2 (let (:) _ arg = π in arg))
  _0 = Just (let (:) arg _ = π in arg)
  ψ = case (let (:) _ arg = π in arg) of { (:) ρ'4 ρ'5 -> (case sel1 ret of { Just ρ'6 -> (case (let (:) arg _ = π in arg) > (let Just arg = sel3 ret in arg) of { True -> Just (let (:) arg _ = π in arg); False -> sel2 ret }); Nothing -> _0 }); [] -> _0 }
...
lam'2 = \ds -> 
  ...
  case ds of { (:) ρ'7 ρ'8 -> Just (case ρ'8 of { (:) ρ'9 ρ'10 -> (case ρ'7 > ret' of { True -> ρ'7; False -> ret' }); [] -> ρ'7 }); [] -> Nothing }
...
lam'3 = \ds'3 -> let
  ...
  in case ds'3 of { (:) ρ'19 ρ'20 -> (case ρ'20 of { (:) ρ'21 ρ'22 -> (case sel1 ret of { Just ρ'23 -> (case ρ'19 > (let Just arg = sel3 ret in arg) of { True -> Just ρ'19; False -> sel2 ret }); Nothing -> _1 }); [] -> _1 }); [] -> Nothing }
