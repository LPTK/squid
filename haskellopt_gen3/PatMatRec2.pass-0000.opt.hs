...
call'2 π xs' xs'2 = case π of { (:) ρ'2 ρ'3 -> ρ'2 + (call'2 ρ'3 (sel2 (call'3 xs')) (sel1 (call'3 xs'))); [] -> sel1 (call'4 False xs'2 (sel2 (call'5 xs')) (sel1 (call'5 xs'))) }
...
call'5 xs'3 = (,) xs'3 xs'3

alternate = lam'

lam'2 flag_xs xs'4 xs'5 = \ds'2 -> case ds'2 of { (:) ρ'8 ρ'9 -> ρ'8 + (call'2 ρ'9 (sel2 (call'3 xs'4)) (sel1 (call'3 xs'4))); [] -> sel1 (call'4 flag_xs xs'5 (sel2 (call'5 xs'4)) (sel1 (call'5 xs'4))) }
...
call'4 flag_xs' xs'6 xs'7 xs'8 = 
  let _cε = sel1 (call'4 False xs'8 (sel2 (call'5 xs'7)) (sel1 (call'5 xs'7))) in
  (,) (case flag_xs' of { True -> _cε; False -> (case xs'6 of { (:) ρ'10 ρ'11 -> ρ'10 + (call'2 ρ'11 (sel2 (call'3 xs'7)) (sel1 (call'3 xs'7))); [] -> _cε }) }) _cε

usum = lam

usum'0 = (0::Int)

call'9 xs'9 xs'10 = sel2 (call'4 True xs'10 (sel2 (call'5 xs'9)) (sel1 (call'5 xs'9)))

lam'3 = \xs -> (lam'2 False xs xs)

call'3 xs'11 = (,) xs'11 xs'11
